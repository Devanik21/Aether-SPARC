...
from ghoststream_backend import run_experiment, SyntheticBurstAudio

st.set_page_config(page_title="AETHER-SPARC Benchmark", layout="wide")

st.title("AETHER-SPARC")
st.subheader("Asynchronous Event-Triggered Sparse Proportional Compute Architecture")

st.markdown("---")

if st.button("Run Strict Fair Benchmark"):
    with st.spinner("Training DenseDSP and AETHER-SPARC under identical conditions..."):
